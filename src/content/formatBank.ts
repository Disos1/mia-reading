...
export const FLASH_BANK: FlashEntry[] = [
  ...
  { id: 'FL_13', tier: 'T2', skill: 'WR_HF_T2', word: 'מדרגות',
    distractors: [{ text: 'מדדגות', pair: 'ר/ד' }, { text: 'מדרגוח', pair: 'ת/ח' }, { text: 'מדרנות', pair: null }] },
  { id: 'FL_14', tier: 'T2', skill: 'WR_HF_T2', word: 'מחברת',
    distractors: [{ text: 'מהברת', pair: 'ה/ח' }, { text: 'מחכרת', pair: 'ב/כ' }, { text: 'מחבדת', pair: 'ר/ד' }] },
  { id: 'FL_15', tier: 'T3', skill: 'WR_HF_T3', word: 'מעבדה',
    distractors: [{ text: 'מעכדה', pair: 'ב/כ' }, { text: 'מעברה', pair: 'ר/ד' }, { text: 'מעבדח', pair: 'ה/ח' }] },
  { id: 'FL_16', tier: 'T3', skill: 'WR_HF_T3', word: 'תגלית',
    distractors: [{ text: 'חגלית', pair: 'ת/ח' }, { text: 'תגליח', pair: 'ת/ח' }, { text: 'תגלות', pair: 'ו/י' }] },
];
...
export const WIC_BANK: WICEntry[] = [
  ...
  { id: 'WIC_11', level: 2, skill: 'COMP_VOCAB',
    sentence: 'הַתַּרְמִיל הָיָה כָּבֵד וְהִיא הִתְקַשְּׁתָה לָשֵׂאת אוֹתוֹ.', targetWord: 'הִתְקַשְּׁתָה',
    explanation: 'הַתַּרְמִיל כָּבֵד — אָז הַנְּשִׂיאָה הָיְתָה קָשָׁה לָהּ.',
    options: ['הָיָה לָהּ קָשֶׁה', 'נֶהֱנְתָה מְאוֹד', 'שָׁכְחָה אוֹתוֹ', 'מִהֲרָה מְאוֹד'] },
  { id: 'WIC_12', level: 3, skill: 'COMP_VOCAB',
    sentence: 'הַשַּׁלֶּכֶת כִּסְּתָה אֶת הַשְּׁבִיל בְּעָלִים כְּתֻמִּים.', targetWord: 'הַשַּׁלֶּכֶת',
    explanation: 'עָלִים נוֹשְׁרִים מֵהָעֵצִים בַּסְּתָו וּמְכַסִּים אֶת הָאֲדָמָה — זוֹ שַׁלֶּכֶת.',
    options: ['נְשִׁירַת הֶעָלִים בַּסְּתָו', 'גֶּשֶׁם חָזָק', 'סוּג שֶׁל עֵץ', 'רוּחַ קָרָה'] },
  { id: 'WIC_13', level: 3, skill: 'COMP_VOCAB',
    sentence: 'הוּא הִבִּיט בַּתְּמוּנָה בְּהִשְׁתָּאוּת.', targetWord: 'בְּהִשְׁתָּאוּת',
    explanation: 'מִי שֶׁרוֹאֶה מַשֶּׁהוּ מַרְשִׁים מְאוֹד מַבִּיט בּוֹ בְּפֶלֶא.',
    options: ['בְּפֶלֶא גָּדוֹל', 'בְּכַעַס', 'בְּשִׁעֲמוּם', 'בְּפַחַד'] },
  { id: 'WIC_14', level: 4, skill: 'COMP_VOCAB',
    sentence: 'הַחוֹקְרִים הִסִּיקוּ מֵהַמִּמְצָאִים שֶׁהַגֶּשֶׁר נִבְנָה לִפְנֵי אַלְפַּיִם שָׁנָה.', targetWord: 'הִסִּיקוּ',
    explanation: 'הֵם לֹא רָאוּ אֶת הַבְּנִיָּה — הֵם הִגִּיעוּ לַמַּסְקָנָה מִתּוֹךְ מָה שֶׁמָּצְאוּ.',
    options: ['הִגִּיעוּ לְמַסְקָנָה', 'שָׁאֲלוּ מִישֶׁהוּ', 'נִחֲשׁוּ בְּלִי סִבָּה', 'כָּתְבוּ סֵפֶר'] },
...
export const ORDERING_BANK: OrderingEntry[] = [
  ...
  { id: 'ORD_4', level: 2, skill: 'COMP_SEQUENCE',
    story: 'סַבְתָּא וְנֹעַם הֵכִינוּ בָּצֵק לְעוּגָה. הֵן שָׁפְכוּ אוֹתוֹ לַתַּבְנִית וְאָפוּ בַּתַּנּוּר. כְּשֶׁהָעוּגָה הִתְקָרְרָה, כֻּלָּם טָעֲמוּ מִמֶּנָּה.',
  ...
  { id: 'ORD_9', level: 3, skill: 'COMP_SEQUENCE',
    story: 'הַמִּשְׁפָּחָה הֶחְלִיטָה לְהַפְתִּיעַ אֶת סַבְתָּא. קֹדֶם הֵם אָפוּ עוּגָה, אַחַר כָּךְ תָּלוּ שְׁלָטִים בַּסָּלוֹן, וְהִסְתַּתְּרוּ מֵאֲחוֹרֵי הַסַּפָּה. כְּשֶׁהִיא נִכְנְסָה, כֻּלָּם קָפְצוּ וְקָרְאוּ "הַפְתָּעָה!"',
    explanation: 'הַהֲכָנוֹת בָּאוֹת לְפִי סֵדֶר, וְהַהַפְתָּעָה עַצְמָהּ הִיא הָאַחֲרוֹנָה.',
    events: ['אָפוּ עוּגָה', 'תָּלוּ שְׁלָטִים', 'הִסְתַּתְּרוּ', 'קָרְאוּ "הַפְתָּעָה!"'] },
  { id: 'ORD_10', level: 4, skill: 'COMP_SEQUENCE',
    story: 'כְּדֵי לְהַגִּישׁ עֲבוֹדָה בִּזְמַן, עִידוֹ בָּנָה לְעַצְמוֹ תָּכְנִית. בַּהַתְחָלָה הוּא רָשַׁם אֶת כָּל הַשְּׁאֵלוֹת שֶׁצָּרִיךְ לַעֲנוֹת עֲלֵיהֶן. אַחַר כָּךְ הוּא חִפֵּשׂ מֵידָע בַּסְּפָרִים וּבָאִינְטֶרְנֶט. כְּשֶׁהָיָה לוֹ מַסְפִּיק חֹמֶר הוּא כָּתַב טְיוּטָה, וּבַסּוֹף עָבַר עָלֶיהָ וְתִקֵּן שְׁגִיאוֹת.',
    explanation: 'תַּכְנוּן ← אִסּוּף מֵידָע ← כְּתִיבָה ← הַגָּהָה. כָּל שָׁלָב נִשְׁעָן עַל הַקּוֹדֵם.',
    events: ['רָשַׁם אֶת הַשְּׁאֵלוֹת', 'חִפֵּשׂ מֵידָע', 'כָּתַב טְיוּטָה', 'תִּקֵּן שְׁגִיאוֹת'] },
...
export const AMBIGUITY_BANK: AmbiguityEntry[] = [
  ...
  { id: 'AMB_9', level: 3, skill: 'DEC_NO_NIKUD_INFER',
    sentence: 'שתינו חלב קר עם עוגייה.', targetWord: 'חלב', pointedForm: 'חָלָב',
    options: ['חָלָב — משקה לבן', 'חֵלֶב — שומן של בעל חיים'],
    explanation: 'שׁוֹתִים אוֹתוֹ, וְהוּא קַר — מְדֻבָּר בַּמַּשְׁקֶה.' },
  { id: 'AMB_10', level: 4, skill: 'DEC_NO_NIKUD_INFER',
    sentence: 'הילדים בנו ארמון גדול בחול.', targetWord: 'בנו', pointedForm: 'בָּנוּ',
    options: ['בָּנוּ — הקימו משהו', 'בָּנוּ — בתוכנו (בְּ+אנחנו)'],
    explanation: 'אַחֲרֵי "הַיְּלָדִים" בָּא מָה שֶׁהֵם עָשׂוּ, וְיֵשׁ מוּשָׂא — "אַרְמוֹן". אָז זוֹ פְּעֻלַּת בְּנִיָּה.' },
